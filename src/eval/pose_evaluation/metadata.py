...
dataset_metadata = {
    ...
    "bonn": {
        "img_path": "/data/jiangzj/InfiniteVGGT/data/boondataset/processed",
        "mask_path": None,
    ...
    "scannet": {
        "img_path": "/data/jiangzj/InfiniteVGGT/data/scannet_processed",
        "mask_path": None,
    ...
    "tum": {
        "img_path": "/data/jiangzj/InfiniteVGGT/data/tum-D/tum",
        "mask_path": None,
