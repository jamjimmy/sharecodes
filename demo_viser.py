...
@torch.no_grad()
def run_inference(model, img_paths, device, size=512, args=None):
...
def main():
    ...
    parser.add_argument("--seq_path", default="testrgb", help="Input folder or video")
    ...
    # Inference & Save
    preds = run_inference(model, img_paths, args.device, args.size, args)
